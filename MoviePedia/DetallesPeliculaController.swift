...
class DetallesPeliculaController : UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var lblRecaudacion: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if pelicula != nil {
            ...
            lblProductora.text = pelicula?.productora
            lblRating.text = pelicula?.rating
            lblRecaudacion.text = pelicula?.recaudacion
            lblPresupuesto.text = pelicula?.presupuesto
